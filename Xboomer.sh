...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing XBoomer'
    else
        figlet XBommer
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mAkmXHack \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border AkmX
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/Akmteam12 \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/@akmtech01 \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of XBoomer for more stability."
    echo " "
}
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN XBoomer Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
